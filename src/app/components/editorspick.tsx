    ...
    <div className="w-full flex justify-center py-[10px] relative bg-[#f5f5f5]">
      <div className="w-full lg:w-[1050px] h-auto flex flex-col gap-[30px] bg-[#FAFAFA] p-[20px] sm:p-[40px]">
        ...
        <div className="flex flex-col items-center gap-[10px]">
          <h3 className="font-Montserrat font-semibold text-[20px] sm:text-[24px] leading-[28px] sm:leading-[32px] animate-text-reveal">
            EDITOR’S PICK
          </h3>
          <p className="w-full sm:w-[347px] font-Montserrat font-normal text-[14px] leading-[20px] text-[#737373] text-center animate-text-reveal">
